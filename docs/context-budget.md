...
`bin/fm-context-measure-lib.sh` implements this measurement; this guard sources it rather than keeping its own copy, and `docs/session-handover.md` documents the sibling caller that shares it.
