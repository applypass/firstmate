...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .turnend-claude-blocks .context-budget-blocks-<session> .context-budget-notice-<session>   Claude Stop auto-arm single-flight, epoch, guard-budget, and per-session context-ceiling stand-down and notice records; never touch
